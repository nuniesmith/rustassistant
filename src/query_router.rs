...
impl QueryRouter {
    ...
    fn generate_direct_answer(&self, query: &str) -> String {
        ...
        if lower.contains("what is rustassistant") || lower.contains("what does rustassistant do") {
            return "Rustassistant is a developer workflow management tool. I can:\n\
                    ...
                    Try: `rustassistant note add \"Your idea\" --tags feature`"
                .to_string();
        }
