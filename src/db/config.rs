...
pub struct DatabaseConfig {
    ...
    /// e.g. postgresql://rustassistant:changeme@postgres:5432/rustassistant
    pub url: String,
...
pub fn get_backup_path() -> std::path::PathBuf {
    ...
    std::path::PathBuf::from(format!("./data/backups/rustassistant_{}.dump", timestamp))
}
...
DATABASE_URL
    ...
    Default: postgresql://rustassistant:changeme@localhost:5432/rustassistant
...
--------------------------
environment:
  - DATABASE_URL=postgresql://rustassistant:${{POSTGRES_PASSWORD}}@postgres:5432/rustassistant

Example — local dev (.env):
----------------------------
DATABASE_URL=postgresql://rustassistant:changeme@localhost:5432/rustassistant
"#
    );
}
...
mod tests {
    ...
    fn test_redact_url() {
        assert_eq!(
            redact_url("postgresql://rustassistant:supersecret@localhost:5432/rustassistant"),
            "postgresql://rustassistant:***@localhost:5432/rustassistant"
        );
        // No password in URL — returned as-is
        assert_eq!(
            redact_url("postgresql://localhost/rustassistant"),
