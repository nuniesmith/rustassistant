...
//! rustassistant todo-scaffold . --overwrite
//!
//! # Write the scaffold plan to a file for inspection / re-use
//! rustassistant todo-scaffold . --output .rustassistant/scaffold.json
//! ```
//!
...
//! - All repos managed by RustAssistant use the same pipeline, so the same
