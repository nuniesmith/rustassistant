...
//!
//! This module is the backend for `rustassistant todo-sync <todo-md> <results-json>`.
...
//! rustassistant todo-sync todo.md .rustassistant/results/batch-001.json --dry-run
//! rustassistant todo-sync todo.md .rustassistant/results/batch-001.json --append-summary
//! ```
//!
//! # Output shape
//!
...
//!   "todo_path": "todo.md",
//!   "results_path": ".rustassistant/results/batch-001.json",
//!   "dry_run": false,
//!   "items_updated": 3,
//!   "items_not_found": 1,
//!   "items_skipped": 0,
...
mod tests {
    ...
    const SAMPLE_TODO: &str = r#"# RustAssistant — TODO Backlog
